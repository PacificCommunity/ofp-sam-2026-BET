# ============================================================
# Create a 4-region input folder that excludes tag release groups
# identified from their original 9-region release region.
#
...
case_name <- paste0("exclude_release_region_", paste(release_regions, collapse = "_"))
out_dir <- env_or_default("out_dir", file.path(out_root, paste0(basename(base_dir_abs), "_", case_name)))
