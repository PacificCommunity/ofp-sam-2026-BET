...
results <- list.dirs(file.path(getwd(), "..", "mfcl"), full.names = TRUE, recursive = FALSE) %>%
...
names(results) <- basename(list.dirs(file.path(getwd(), "..", "mfcl"), full.names = TRUE, recursive = FALSE))
