...
models <- list(
  ...
  "2023R9_ExRG21_25" = list(
    ...
    "description"="Exclude RG21 and RG25 from 2023 BET diagnostic model",
  ...
  , "2023R6_ExR6Index" = list(
    
    "description" = "R6 (equivalent to R9 in the 2023 diagnostic model) index relaxed by assuming a very high CV",
    
    mfcl_commands ="./doitall.sh",
    program_path = "mfcl/exe/mfclo64_2026_02_04_vsn2278",  # Model-specific path
    base_dir = "mfcl/inputs/2023_6region_exclude_R6index",                   # Model-specific dir
